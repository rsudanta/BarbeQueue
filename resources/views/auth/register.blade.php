    ...
    <div class="container box-register">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row" style="margin-top:70px">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" style="width:400px" class="form-control @error('name') is-invalid @enderror" placeholder="Nama" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
